 ...
 * top-left corner of the DSH window, just above the DeepSeek brand. It answers a
 * single question at a glance: is Beijing time currently inside the platform's
 * peak work window?
 *
...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		 ...
		 * column's scroll container; pointer-events stays "none" so it can never
		 * swallow a click meant for the brand or the icon underneath it.
		 */
		function WorkBadge() {
